...
ip route add ${aws_vpc1_cidr} dev vti-t1 table 220 metric 10
ip route add ${aws_vpc1_cidr} dev vti-t2 table 220 metric 20
ip route add ${aws_vpc2_cidr} dev vti-t1 table 220 metric 10
ip route add ${aws_vpc2_cidr} dev vti-t2 table 220 metric 20
