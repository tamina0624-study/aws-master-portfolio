...
| [13-basic-infrastructure-CDK](projects/13-basic-infrastructure-CDK/) | 同構成を AWS CDK (TypeScript) で再実装 |
...
| プロジェクト | 内容 |
|------------|------|
| [08-alertConstruct](projects/08-alertConstruct/) | CloudWatch + SNS + Lambda によるアラート設計と通知整形 |
| [14-log-learning](projects/14-log-learning/) | AWS 全サービスのログ設計・Athena 分析・CloudWatch Insights・QuickSight 可視化 |
| [15-analyze-research](projects/15-analyze-research/) | 可視化・ネットワーク監視・セキュリティ権限の調査・分析 |
...
| [17-cicd-pipeline](projects/17-cicd-pipeline/) | Python + Docker + Terraform を対象に GitHub Actions で構築した CI/CD（OIDC・多層セキュリティスキャン・段階的デプロイ）|
