...
variable "vpc_name" {
  description = "VPC名"
  type        = string
  default     = "log-learning-vpc"
}
variable "public_subnet_name_1" {
  description = "パブリックサブネット1の名前"
  type        = string
  default     = "log-learning-public-subnet-1"
}
variable "public_subnet_name_2" {
  description = "パブリックサブネット2の名前"
  type        = string
  default     = "log-learning-public-subnet-2"
}
variable "igw_name" {
  description = "インターネットゲートウェイ名"
  type        = string
  default     = "log-learning-igw"
}
variable "route_table_name" {
  description = "ルートテーブル名"
  type        = string
  default     = "log-learning-public-rt"
}
variable "nacl_name" {
  description = "NACL名"
  type        = string
  default     = "log-learning-public-acl"
}


variable "s3_bucket_name" {
  description = "VPC Flow Log用S3バケットARN"
  type        = string
}
