...
| SecurityGroupIds     | log-leaning-ec2-web-sg        | log-leaning-sg（共通SG）     |
| SubnetId             | subnet-public-10.14.1.0/24  | log-leaning-public-subnet    |
...
- サブネットはlog-leaning-public-subnet（10.14.1.0/24）を利用
