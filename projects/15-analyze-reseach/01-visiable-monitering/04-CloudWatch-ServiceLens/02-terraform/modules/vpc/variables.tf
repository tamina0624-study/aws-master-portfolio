...
variable "igw_name" {
  ...
  type        = string
  default     = "analyze-research-igw"
}
variable "route_table_name" {
  description = "ルートテーブル名"
  type        = string
  default     = "analyze-research-public-rt"
}
variable "nacl_name" {
  description = "NACL名"
  type        = string
  default     = "analyze-research-public-acl"
}
